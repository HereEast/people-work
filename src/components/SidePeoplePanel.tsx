...
function AddButton() {
  return (
    <div className="flex size-20 items-center justify-center overflow-hidden rounded-xl bg-slate-950 text-slate-50 transition hover:scale-[105%] hover:animate-anime hover:bg-gradient-base-diagonal hover:bg-[length:400%]">
...
function Tooltip({ children }: TooltipProps) {
  return (
    <div className="invisible absolute bottom-[110%] flex h-fit w-36 flex-col truncate rounded-[12px] bg-brand-blue-600 p-1.5 px-2 text-xs leading-none text-stone-50 group-hover/side-tile:visible lg:bottom-2 lg:right-[110%] lg:w-28">

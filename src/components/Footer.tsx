...
export function Footer() {
  return (
    <footer className="w-full px-2 py-4 sm:px-6">
      <div className="flex w-full flex-col-reverse justify-between gap-10 text-xl font-medium leading-[120%] sm:flex-row sm:items-center sm:gap-0 md:text-3xl">
        ...
        <div className="flex flex-col gap-px sm:flex-row sm:gap-6">
          {FOOTER_LINKS.map((link, index) => (
            <Button
              ...
              view="base"
              underline
              // className="underline decoration-2 underline-offset-[2px] sm:no-underline"
              key={index}
            >
              {link.label}
            </Button>
